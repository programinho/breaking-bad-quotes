...
return ajax.core.GET.cljs$core$IFn$_invoke$arity$variadic("https://breaking-bad-quotes.herokuapp.com/v1/quotes",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"handler","handler",-195596612),(function (p1__26772_SHARP_){
return cljs.core.reset_BANG_(data,p1__26772_SHARP_);
}),new cljs.core.Keyword(null,"error-handler","error-handler",-484945776),(function (p__26773){
...
var status = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26774__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
var status_text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26774__$1,new cljs.core.Keyword(null,"status-text","status-text",-1834235478));
...
return (function (){
var map__26776 = cljs.core.first(cljs.core.deref(data));
...
var quote = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26776__$1,"quote");
var author = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26776__$1,"author");
...
var G__26778 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [breaking_bad_quotes.core.navbar], null);
var G__26779 = document.getElementById("app");
return (reagent.core.render_component.cljs$core$IFn$_invoke$arity$2 ? reagent.core.render_component.cljs$core$IFn$_invoke$arity$2(G__26778,G__26779) : reagent.core.render_component.call(null,G__26778,G__26779));
});
