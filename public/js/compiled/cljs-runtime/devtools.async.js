...
var o__26390__auto___28752 = (function (){var o__26390__auto__ = (function (){var o__26390__auto__ = Promise;
return (o__26390__auto__["resolve"]).call(o__26390__auto__);
})();
return (o__26390__auto__["then"]).call(o__26390__auto__,callback);
})();
(o__26390__auto___28752["catch"]).call(o__26390__auto___28752,devtools.async.rethrow_outside_promise);
...
var G__28747_28760 = Error;
var target__26405__auto___28761 = G__28747_28760;
if(cljs.core.truth_(target__26405__auto___28761)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28747_28760)].join(''),"\n","target__26405__auto__"].join('')));
}

(target__26405__auto___28761["stackTraceLimit"] = Infinity);
