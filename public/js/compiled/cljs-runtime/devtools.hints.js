...
var G__27119 = cljs.core.PersistentArrayMap.EMPTY;
var G__27120 = native_stack_trace;
var G__27121 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__27122 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__27119,G__27120,G__27121,G__27122) : cljs.stacktrace.parse_stacktrace.call(null,G__27119,G__27120,G__27121,G__27122));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27128__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27128__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27128__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e27127){var _e = e27127;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___27158 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5718__auto___27158)){
var seen_errors_27159 = temp__5718__auto___27158;
if(cljs.core.truth_(seen_errors_27159.has(self))){
} else {
seen_errors_27159.add(self);

var temp__5720__auto___27160 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5720__auto___27160)){
var sense_27161 = temp__5720__auto___27160;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_27161)].join('');
} else {
}
}
} else {
