...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__26648){
...
var request = map__26649__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26649__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__26653 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__26653.cljs$core$IFn$_invoke$arity$1 ? fexpr__26653.cljs$core$IFn$_invoke$arity$1(response) : fexpr__26653.call(null,response));
});

ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__26654 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__26654.cljs$core$IFn$_invoke$arity$1 ? fexpr__26654.cljs$core$IFn$_invoke$arity$1(response) : fexpr__26654.call(null,response));
});
});

ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2;

ajax.formats.accept_header = (function ajax$formats$accept_header(p__26655){
...
var request = map__26656__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26656__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
