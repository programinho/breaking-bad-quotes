...
var G__27459 = devtools.prefs.pref(v);
v = G__27459;
continue;
} else {
return v;
...
}catch (e27397){var _e__26417__auto__ = e27397;
return false;
}})();
...
}catch (e27401){var _e__26417__auto__ = e27401;
return false;
}})();
...
}catch (e27403){var _e__26417__auto__ = e27403;
return false;
}}
}
});
...
var vec__27431 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27431,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27431,(1),null);
...
return cljs.core.some((function (p1__27439_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27439_SHARP_);
}),template);
});
