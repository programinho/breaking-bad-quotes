...
var G__33355 = cljs.core.PersistentArrayMap.EMPTY;
var G__33356 = native_stack_trace;
var G__33357 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__33358 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__33355,G__33356,G__33357,G__33358) : cljs.stacktrace.parse_stacktrace.call(null,G__33355,G__33356,G__33357,G__33358));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33361__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33361__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33361__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e33360){var _e = e33360;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___33389 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5718__auto___33389)){
var seen_errors_33393 = temp__5718__auto___33389;
if(cljs.core.truth_(seen_errors_33393.has(self))){
} else {
seen_errors_33393.add(self);

var temp__5720__auto___33394 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5720__auto___33394)){
var sense_33395 = temp__5720__auto___33394;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_33395)].join('');
} else {
}
}
} else {
