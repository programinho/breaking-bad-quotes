...
var G__33785 = devtools.prefs.pref(v);
v = G__33785;
continue;
} else {
return v;
...
}catch (e33756){var _e__24713__auto__ = e33756;
return false;
}})();
...
}catch (e33766){var _e__24713__auto__ = e33766;
return false;
}})();
...
}catch (e33769){var _e__24713__auto__ = e33769;
return false;
}}
}
});
...
var vec__33777 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33777,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33777,(1),null);
...
return cljs.core.some((function (p1__33781_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__33781_SHARP_);
}),template);
});
