...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__38029){
...
var request = map__38031__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38031__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__38041 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__38041.cljs$core$IFn$_invoke$arity$1 ? fexpr__38041.cljs$core$IFn$_invoke$arity$1(response) : fexpr__38041.call(null,response));
});

ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__38043 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__38043.cljs$core$IFn$_invoke$arity$1 ? fexpr__38043.cljs$core$IFn$_invoke$arity$1(response) : fexpr__38043.call(null,response));
});
});

ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2;

ajax.formats.accept_header = (function ajax$formats$accept_header(p__38044){
...
var request = map__38045__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38045__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
