...
var G__38134 = format;
var G__38134__$1 = (((G__38134 instanceof cljs.core.Keyword))?G__38134.fqn:null);
switch (G__38134__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__38143 = cljs.core.second(format);
var G__38144 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__38143,G__38144) : ajax.easy.keyword_response_format_element.call(null,G__38143,G__38144));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38150_SHARP_){
return ajax.easy.keyword_response_format_element(p1__38150_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__38167){
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38168__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38168__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38168__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return ((function (h,e,map__38168,map__38168__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__38177){
var vec__38178 = p__38177;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38178,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38178,(1),null);
var fexpr__38181_38228 = (cljs.core.truth_(ok)?h:e);
(fexpr__38181_38228.cljs$core$IFn$_invoke$arity$1 ? fexpr__38181_38228.cljs$core$IFn$_invoke$arity$1(result) : fexpr__38181_38228.call(null,result));
...
;})(h,e,map__38168,map__38168__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__38190){
...
var opts = map__38191__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38191__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38191__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38191__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38191__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38191__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
