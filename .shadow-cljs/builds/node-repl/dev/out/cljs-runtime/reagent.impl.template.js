...
var G__37867 = o;
(G__37867[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__38026__i < G__38026__a.length) {G__38026__a[G__38026__i] = arguments[G__38026__i + 0]; ++G__38026__i;}
  args = new cljs.core.IndexedSeq(G__38026__a,0,null);
} 
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__37922){
...
var props = map__37923__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37923__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__37949){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37950__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__37950,map__37950__$1,on_write){
return (function (){
...
});})(node_value,map__37950,map__37950__$1,on_write))
);
} else {
...
reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__37970){
...
var synthetic_on_update = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37971__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37971__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
...
var G__37974 = jsprops;
(G__37974["defaultValue"] = value);

(G__37974["onChange"] = ((function (G__37974,v,value,on_change,on_change__$1,map__37971,map__37971__$1,synthetic_on_update,synthetic_on_change){
return (function (p1__37962_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change__$1,p1__37962_SHARP_);
});})(G__37974,v,value,on_change,on_change__$1,map__37971,map__37971__$1,synthetic_on_update,synthetic_on_change))
);
...
var vec__37982 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37982,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37982,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37982,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___38084 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___38084 == null)){
} else {
var key_38086 = temp__5724__auto___38084;
(jsprops["key"] = key_38086);
}
...
reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__37991){
...
var synthetic_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37992__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__37994 = reagent.impl.template.__GT_NativeWrapper();
(G__37994["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__37995 = wrapped;
(G__37995["syntheticInput"] = true);

return G__37995;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__37996 = wrapped__$1;
(G__37996["syntheticOnChange"] = on_change);

return G__37996;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__37997 = wrapped__$2;
(G__37997["syntheticOnUpdate"] = on_update);
...
var len__4730__auto___38105 = arguments.length;
var i__4731__auto___38106 = (0);
while(true){
if((i__4731__auto___38106 < len__4730__auto___38105)){
args__4736__auto__.push((arguments[i__4731__auto___38106]));

var G__38107 = (i__4731__auto___38106 + (1));
i__4731__auto___38106 = G__38107;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq38003){
var G__38004 = cljs.core.first(seq38003);
var seq38003__$1 = cljs.core.next(seq38003);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38004,seq38003__$1);
});
...
break;
default:
var G__38114 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__38114;
continue;
...
var n__4607__auto___38118 = a.length;
var i_38119 = (0);
while(true){
if((i_38119 < n__4607__auto___38118)){
(a[i_38119] = reagent.impl.template.as_element((a[i_38119])));

var G__38120 = (i_38119 + (1));
i_38119 = G__38120;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___38121 = a.length;
var i_38122 = (0);
while(true){
if((i_38122 < n__4607__auto___38121)){
var val_38123 = (a[i_38122]);
if(((cljs.core.vector_QMARK_(val_38123)) && ((reagent.impl.template.key_from_vec(val_38123) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_38122] = reagent.impl.template.as_element(val_38123));
...
var ctx = ({});
var vec__38013 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38013,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38013,(1),null);
...
var G__38017 = (cljs.core.count(argv) - first_child);
switch (G__38017) {
case (0):
return shadow.js.shim.module$react.createElement(comp,jsprops);

break;
case (1):
var G__38019 = comp;
var G__38020 = jsprops;
var G__38021 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return shadow.js.shim.module$react.createElement(G__38019,G__38020,G__38021);

break;
default:
return shadow.js.shim.module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__38017){
